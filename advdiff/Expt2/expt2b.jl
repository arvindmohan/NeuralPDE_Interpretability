#### Expt 2(b)
# Both numerical scheme combinations are stable. 
# Goal: Observe variance in extrapolation stability with IC.

using DifferentialEquations,SciMLSensitivity,Zygote,LinearAlgebra, NPZ, Plots
using SparseArrays, Random, Statistics, Optimisers, Flux, ForwardDiff, Calculus, FileIO, JLD2
...
checkpoint_fpath = "./ckpt_expt2b.jld2"
...
#ROM numerical scheme #DIFFERENT
∂x1_rom = f1_sixthOrder_central(N,dx)
...
for epoch in 1:epochs
    ...
    if epoch%ckpt_save_freq == 0
        ...
        fname = "telemetry_caseA_expt2b_epoch" * string(epoch)  * ".npz"
...
npzwrite("trainloss_caseA_expt2b.npz", Dict("loss_history" => loss_history))
...
fname = "telemetry_caseA_expt2b_inference_train.npz"
...
fname = "telemetry_caseA_expt2b_inference_test.npz"
